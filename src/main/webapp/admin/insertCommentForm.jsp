...
<body>
	...
	<!-- 답변 -->
		<form method="post" action="<%=request.getContextPath()%>/admin/insertCommentAction.jsp?helpNo=<%=helpNo%>" id="insertCommentForm">
			<div class="card-header">문의 답변하기</div>
			<table class="table">
				<tr>
					<td>답변</td>
					<td>
						<textarea class="form-control" id="commentMemo" rows="3" name="commentMemo"></textarea>
					</td>
				</tr>
			</table>
			<div class="text-center">
				<button type="button" class="btn btn-primary" id="insertCommentBtn">등록</button>
			</div>
		</form>
	</div>
	<!-- 유효성 검사 -->
